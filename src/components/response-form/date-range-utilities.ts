...
export function addDateStringsToSet(dateStringSet: Set<string>, dateStrings: string[]): Set<string> {
...
export function removeDateStringsFromSet(dateStringSet: Set<string>, dateStrings: string[]): Set<string> {
  const updatedSet = new Set(dateStringSet)
  for (const dateString of dateStrings) {
