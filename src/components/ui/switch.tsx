  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-background dark:data-[state=unchecked]:bg-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=checked]:bg-black data-[state=unchecked]:translate-x-0 dark:data-[state=checked]:bg-black",
        )}
      />
    </SwitchPrimitive.Root>
  );
