...
function ShareTripPage() {
  ...
  return (
    <div className="min-h-screen bg-background-dark">
      <header className="w-full border-b border-surface-darker bg-background-dark/95 backdrop-blur sticky top-0 z-50">
        <div className="px-4 md:px-10 py-3 max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 text-white">
            ...
            <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em]">when2travel</h2>
          </div>
        </div>
      </header>
